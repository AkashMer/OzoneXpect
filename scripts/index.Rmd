...
str(airquality)
```
**`r 100 - round(mean(complete.cases(airquality))*100, 2)`% of rows** contain missing values. `impute.knn()` function with `k = 10` from the `impute` package was used to impute these missing values
